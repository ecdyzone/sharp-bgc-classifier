...
## Project 2 — Genomic Neighborhood Knowledge Graphs

Two interactive graphs exploring how functional roles are spatially organized within BGCs.
Both are hosted on GitHub Pages — open them in any browser, drag nodes, and hover for details.

### Graph A — MIBiG genomic neighborhood

> 🔗 **[Open interactive graph](https://ecdyzone.github.io/sharp-bgc-classifier/knowledge_graph.html)**
...
> 🔗 **[Open interactive graph](https://ecdyzone.github.io/sharp-bgc-classifier/antismash_graph.html)**
...
- [ ] Nextflow pipeline wrapping all project 1+2 scripts (see `main.nf`)
